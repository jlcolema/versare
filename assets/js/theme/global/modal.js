...
export class Modal {
    ...
    onModalClose() {
        ...
        const learnmodalContent = $(this.$content[0]).hasClass('learn-more-content');
        if (learnmodalContent === true) {
            $('#learn-more-iframe').attr('src', '#');
        }
    }
    ...
    onModalOpen() {
        ...
        const learnmodalContent = $(this.$content[0]).hasClass('learn-more-content');
        if (learnmodalContent === true) {
            $('#learn-more-iframe').attr('src', 'https://www.youtube.com/embed/kPMhStQDr6Q?autoplay=1');
        }
    }
